...
Transition transitions[] = {
  {DelayTimePredicate, 0, 1, nullptr, EventStates}, // State-1 - Current-State = 0, Next-State = 1
  {DelayTimePredicate, 1, 2, nullptr, EventStates}, // State-2 - Current-State = 1, Next-State = 2
  {DelayTimePredicate, 2, 0, nullptr, EventStates}, // State-3 - Current-State = 2, Next-State = 0
};
